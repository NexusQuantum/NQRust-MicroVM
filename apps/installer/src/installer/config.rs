...
# Allow direct file paths for images (development only)
MANAGER_ALLOW_IMAGE_PATHS=false

# Disable VM reconciler (set to 1 to disable)
MANAGER_RECONCILER_DISABLED=0
