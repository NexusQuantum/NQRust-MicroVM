...
#[openapi(
    ...
    paths(
        ...
        crate::features::runtime_snapshots::routes::list,
        crate::features::runtime_snapshots::routes::get_one,
        crate::features::runtime_snapshots::routes::create,
        crate::features::runtime_snapshots::routes::delete_one,
        crate::features::runtime_snapshots::routes::rebuild,
    ...
    components(
        schemas(
            ...
            nexus_types::RuntimeSnapshot,
            nexus_types::CreateRuntimeSnapshotReq,
            nexus_types::CreateRuntimeSnapshotResp,
            nexus_types::ListRuntimeSnapshotsResp,
            nexus_types::GetRuntimeSnapshotResp,
            nexus_types::RebuildRuntimeSnapshotResp,
    ...
    tags(
        ...
        (name = "Runtime Snapshots", description = "Container runtime warm boot snapshot APIs."),
