...
pub fn auth_router() -> Router {
    Router::new()
        ...
        .route("/me/preferences", get(routes::get_preferences).patch(routes::update_preferences))
        .route("/me/profile", get(routes::get_profile).patch(routes::update_profile))
        .route("/me/password", post(routes::change_password))
        .route("/me/avatar", post(routes::upload_avatar).delete(routes::delete_avatar))
