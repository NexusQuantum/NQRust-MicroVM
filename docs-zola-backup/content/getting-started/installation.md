+++
title = "Installation"
description = "Complete installation guide for NQRust-MicroVM"
weight = 2
date = 2025-12-01
...
This guide will take you from a fresh Linux system to a fully operational NQRust-MicroVM environment.
...
# See Bridged Networking guide for detailed instructions
```

**Warning:** Bridged mode modifies your network configuration. Make sure you have console/VNC access in case SSH breaks!

**For most development, use NAT Mode (Option A).**

See [Bridged Networking Setup](/operations/bridged-networking/) for detailed instructions.
...
**Agent requires sudo for KVM access**
...
You'll need VM images first. See [Quick Start Guide](/getting-started/quick-start/) for image setup instructions.
...
See [Container Guide](/user-guide/containers/) for complete container feature documentation.
...
1. **[Quick Start Guide](/getting-started/quick-start/)** - Create your first VM
2. **[User Guide](/user-guide/)** - Explore all features
3. **[Operations](/operations/)** - Performance tuning and production deployment

---

**Setup complete! You should now have a fully functional NQRust-MicroVM environment.** 🎉
